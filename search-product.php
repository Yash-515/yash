                            ...
                            if (in_array($productByCode["id"], array_keys($_SESSION["cart_item"]))) {
                                foreach ($_SESSION["cart_item"] as $k => $v) {
                                    if ($productByCode["id"] == $k) {
                                        ...
                                        (int)$_SESSION["cart_item"][$k]["quantity"] += (int)$_POST["quantity"];
                                    }
                                }
                            } else {
                    ...
                    <div class="table-wrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="search-product.php?action=remove&code=<?php echo $item["code"]; ?>"
                                class="btnRemoveAction"><img src="dist/img/remove.png" alt="Remove Item" /></a></td>
                          </tr>
                          <?php
                      ...
                      <div class="form-row">
                        <div class="col-md-6 mb-10">
                          ...
                          <input type="text" class="form-control" id="validationCustom03" placeholder="Customer Name"
                        ...
                        <div class="col-md-6 mb-10">
                          ...
                          <input type="text" class="form-control" id="validationCustom03" placeholder="Mobile Number"
                        ...
                        <div class="col-md-6 mb-10">
                          ...
                          <div class="custom-control custom-radio mb-10">
                            <input type="radio" class="custom-control-input" id="customControlValidation2"
                              name="paymentmode" value="cash" required>
                          ...
                          <div class="custom-control custom-radio mb-10">
                            <input type="radio" class="custom-control-input" id="customControlValidation3"
                              name="paymentmode" value="card" required>
